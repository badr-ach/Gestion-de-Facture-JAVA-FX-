CREATE DATABASE  IF NOT EXISTS `factures` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `factures`;
-- MySQL dump 10.13  Distrib 8.0.27, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: factures
-- ------------------------------------------------------
...
CREATE TABLE `clients` (
  ...
  `contactClient` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `fournisseurs` (
  ...
  `contactFournisseur` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2022-01-12  4:02:08
